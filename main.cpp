...
int main()
{
    const char* path_f = "/Users/vladimirskobcov/Desktop/lab/lab_parallel_prog/lab_1/parallel/parallel/input_f.txt";
    const char* path_s = "/Users/vladimirskobcov/Desktop/lab/lab_parallel_prog/lab_1/parallel/parallel/input_s.txt";
    const char* r_m = "rt";
    
    const char* e_path = "/Users/vladimirskobcov/Desktop/lab/lab_parallel_prog/lab_1/parallel/parallel/output.txt";
    const char* w_m = "wt";
    ...
    std::cout << "\nPython check script\n" << std::endl;
    system("python /Users/vladimirskobcov/PycharmProjects/pythonProject6/venv/check.py");
    return 0;
}
